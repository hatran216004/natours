    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('http://127.0.0.1:3000/api/v1/users/signup', {
            name: name,
            email: email,
            password: password,
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGF0cmFuMjMxMDA0IiwiYSI6ImNtMHo0NDVkdjAyMTIybHM0Y3dqaWJyb3gifQ.CkMPJKCsWk14wQzBUDlFFw';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)(res.data.status, "".concat(type.toUpperCase(), " successfully"));
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // eslint-disable
var stripe = Stripe('pk_test_51QErlvGGF6pNW390bfAyfwn5YkIWRDKGxeXJjTVzxT9OP2EfakZvgybFnFikXqoN9EhxbG9aceJxSbbGqEyply1Q00XqWdkDFJ');
